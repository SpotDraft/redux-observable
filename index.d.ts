...
export interface EpicMiddleware<T extends Action, O extends T = T, S = any, D = any> extends Middleware {
...
export declare function createEpicMiddleware<T extends Action, O extends T = T, S = any, D = any>(options?: Options<D>): EpicMiddleware<T, O, S, D>;

export declare function combineEpics<T extends Action, O extends T = T, S = any, D = any>(...epics: Epic<T, O, S, D>[]): Epic<T, O, S, D>;
